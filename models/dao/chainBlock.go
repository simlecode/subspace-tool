...
func (d *Dao) SaveFillAlreadyBlockNum(c context.Context, blockNum int) error {
	...
	// defer conn.Close()
	// if num, _ := redis.Int(conn.Do("GET", FillAlreadyBlockNum)); blockNum > num {
	// 	_, err = conn.Do("SET", FillAlreadyBlockNum, blockNum)
	// }
	// return nil
...
func (d *Dao) SaveFillAlreadyFinalizedBlockNum(ctx context.Context, blockNum int) error {
	...
	// if num, _ := redis.Int(conn.Do("GET", FillFinalizedBlockNum)); blockNum > num {
...
func (d *Dao) GetFillBestBlockNum(c context.Context) (int, error) {
	// conn, _ := d.redis.GetContext(c)
	// defer conn.Close()
	// num, err = redis.Int(conn.Do("GET", FillAlreadyBlockNum))
...
func (d *Dao) GetFillFinalizedBlockNum(c context.Context) (int, error) {
	// conn, _ := d.redis.GetContext(c)
	// defer conn.Close()
	// num, err = redis.Int(conn.Do("GET", FillFinalizedBlockNum))
